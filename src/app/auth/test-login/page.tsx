...
export default function TestLogin() {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // Use a direct approach without extra parameters
    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-4">
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-md">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">Simplified login to isolate authentication issues</p>
        </div>
        ...
        <div className="text-sm mt-6">
          ...
          <ol className="list-decimal list-inside space-y-1 text-gray-600">
            <li>This page uses a simplified NextAuth configuration</li>
            <li>It disables automatic redirects to better diagnose errors</li>
            <li>Error messages will be displayed in the red box above</li>
